#
# Configure the AwesimBranding specific options here
# see: https://github.com/AweSim-OSC/awesim_branding
#

AwesimBranding.configure do |config|
  # The app title used in the layout
  # Default: Rails.application.class.parent_name.titleize
  #config.app_title = 'New Title Here'

  # Whether dynamic routing is used to host local files under `AwesimBranding.dataroot`
  # Default: true
  # @deprecated Routing has been moved to OodAppkit
  config.routes = false
