...
## [Unreleased]
account for options with numbers after hyphens & underscores (#1656)\
update dependencies (#1653)\
Internationalize Apps menu title (#1665)\
Update Changelog (#1652)\
Depend on NodeJS 14 for deb packages (#1660)
