...
## [Unreleased]
enumerate over activemodel#errors as an array, not hash (#1928)\
Bump ood_packaging gem version (#1933)\
rnode location edits account for relative paths (#1934)\
update dependencies (#1927)
