...
Requires:        ondemand-nginx = 1.26.3-3.p6.1.0.ood%{runtime_version}%{?dist}
...
%__mv %{buildroot}/opt/ood/apps/system-status %{buildroot}%{_localstatedir}/www/ood/apps/sys/system-status
