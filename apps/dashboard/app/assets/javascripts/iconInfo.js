...
FA4iconinfo = [{
    ...
    "title": "fa fa-times",
    "searchTerms": ["close", "exit", "x", "cross", "remove", "close"]
}, {
    ...
    "title": "fa fa-repeat",
    "searchTerms": ["redo", "forward", "rotate-right"]
}, {
    "title": "fa fa-refresh",
    ...
    "searchTerms": ["write", "edit", "update", "edit"]
}, {
    ...
    "searchTerms": ["warning", "error", "problem", "notification", "alert", "warning"]
}, {
    "title": "fa fa-plane",
    "searchTerms": ["travel", "trip", "location", "destination", "airplane", "fly", "mode"]
}, {
    ...
    "searchTerms": ["graph", "analytics", "bar-chart-o"]
}, {
    ...
    "searchTerms": ["social network", "facebook-f"]
}, {
    "title": "fa fa-github",
    "searchTerms": ["octocat"]
}, {
    ...
    "title": "fa fa-users",
    "searchTerms": ["people", "profiles", "persons", "group"]
}, {
    "title": "fa fa-link",
    "searchTerms": ["chain", "chain"]
}, {
    "title": "fa fa-cloud",
    "searchTerms": ["save"]
}, {
    ...
    "title": "fa fa-files-o",
    "searchTerms": ["duplicate", "clone", "copy", "copy"]
}, {
    ...
    "title": "fa fa-bars",
    "searchTerms": ["menu", "drag", "reorder", "settings", "list", "ul", "ol", "checklist", "todo", "list", "hamburger", "navicon", "reorder"]
}, {
    "title": "fa fa-list-ul",
    "searchTerms": ["ul", "ol", "checklist", "todo", "list"]
}, {
    ...
    "title": "fa fa-sort",
    "searchTerms": ["order", "unsorted"]
}, {
    "title": "fa fa-sort-desc",
    "searchTerms": ["dropdown", "more", "menu", "arrow", "sort-down"]
}, {
    "title": "fa fa-sort-asc",
    "searchTerms": ["arrow", "sort-up"]
}, {
    ...
    "title": "fa fa-bolt",
    "searchTerms": ["lightning", "weather", "flash"]
}, {
    "title": "fa fa-sitemap",
    "searchTerms": ["directory", "hierarchy", "organization"]
}, {
    ...
    "title": "fa fa-mobile",
    "searchTerms": ["cell phone", "cellphone", "text", "call", "iphone", "number", "telephone", "mobile-phone"]
}, {
    ...
    "searchTerms": ["more", "dropdown", "menu", "toggle-down"]
}, {
    "title": "fa fa-caret-square-o-up",
    "searchTerms": ["toggle-up"]
}, {
    "title": "fa fa-caret-square-o-right",
    "searchTerms": ["next", "forward", "toggle-right"]
}, {
    "title": "fa fa-eur",
    "searchTerms": ["euro"]
}, {
    ...
    "title": "fa fa-jpy",
    "searchTerms": ["cny", "rmb", "yen"]
}, {
    "title": "fa fa-rub",
    "searchTerms": ["ruble", "rouble"]
}, {
    "title": "fa fa-krw",
    "searchTerms": ["won"]
}, {
    ...
    "searchTerms": ["heart", "like", "favorite", "love", "gittip"]
}, {
    "title": "fa fa-sun-o",
    "searchTerms": ["weather", "contrast", "lighter", "brighten", "day"]
}, {
    ...
    "searchTerms": ["previous", "back", "toggle-left"]
}, {
    ...
    "searchTerms": ["institution", "bank"]
}, {
    "title": "fa fa-graduation-cap",
    "searchTerms": ["learning", "school", "student", "mortar-board"]
}, {
    "title": "fa fa-yahoo",
    "searchTerms": []
}, {
    ...
    "title": "fa fa-car",
    "searchTerms": ["vehicle", "automobile"]
}, {
    "title": "fa fa-taxi",
    "searchTerms": ["vehicle", "cab"]
}, {
    "title": "fa fa-tree",
    "searchTerms": []
}, {
    ...
    "searchTerms": ["file-photo-o", "file-picture-o"]
}, {
    "title": "fa fa-file-archive-o",
    "searchTerms": ["file-zip-o"]
}, {
    "title": "fa fa-file-audio-o",
    "searchTerms": ["file-sound-o"]
}, {
    "title": "fa fa-file-video-o",
    "searchTerms": ["file-movie-o"]
}, {
    ...
    "searchTerms": ["life-bouy", "life-buoy", "life-saver", "support"]
}, {
    "title": "fa fa-circle-o-notch",
    "searchTerms": []
}, {
    "title": "fa fa-rebel",
    "searchTerms": ["ra", "resistance"]
}, {
    "title": "fa fa-empire",
    "searchTerms": ["ge"]
}, {
    ...
    "searchTerms": ["y-combinator-square", "yc-square"]
}, {
    ...
    "searchTerms": ["power", "battery-4", "battery"]
}, {
    "title": "fa fa-battery-three-quarters",
    "searchTerms": ["power", "battery-3"]
}, {
    "title": "fa fa-battery-half",
    "searchTerms": ["power", "battery-2"]
}, {
    "title": "fa fa-battery-quarter",
    "searchTerms": ["power", "battery-1"]
}, {
    "title": "fa fa-battery-empty",
    "searchTerms": ["power", "battery-0"]
}, {
    ...
    "searchTerms": ["hourglass-1"]
}, {
    "title": "fa fa-hourglass-half",
    "searchTerms": ["hourglass-2"]
}, {
    "title": "fa fa-hourglass-end",
    "searchTerms": ["hourglass-3"]
}, {
    "title": "fa fa-hourglass",
    "searchTerms": []
}, {
    "title": "fa fa-hand-rock-o",
    "searchTerms": ["hand-grab-o"]
}, {
    "title": "fa fa-hand-paper-o",
    "searchTerms": ["stop", "hand-stop-o"]
}, {
    ...
    "searchTerms": ["display", "computer", "monitor", "tv"]
}, {
    "title": "fa fa-contao",
    "searchTerms": []
}, {
    ...
    "searchTerms": ["asl-interpreting"]
}, {
    "title": "fa fa-deaf",
    "searchTerms": ["deafness", "hard-of-hearing"]
}, {
    "title": "fa fa-glide",
    "searchTerms": []
}, {
    ...
    "searchTerms": ["google-plus-circle"]
}, {
    ...
    "title": "fa fa-id-card",
    "searchTerms": ["drivers-license"]
}, {
    "title": "fa fa-id-card-o",
    "searchTerms": ["drivers-license-o"]
}, {
    "title": "fa fa-quora",
    "searchTerms": []
}, {
    ...
    "searchTerms": ["thermometer-4", "thermometer"]
}, {
    "title": "fa fa-thermometer-three-quarters",
    "searchTerms": ["thermometer-3"]
}, {
    "title": "fa fa-thermometer-half",
    "searchTerms": ["thermometer-2"]
}, {
    "title": "fa fa-thermometer-quarter",
    "searchTerms": ["thermometer-1"]
}, {
    "title": "fa fa-thermometer-empty",
    "searchTerms": ["thermometer-0"]
}, {
    "title": "fa fa-shower",
    "searchTerms": []
}, {
    "title": "fa fa-bath",
    "searchTerms": ["bathtub", "s15"]
}, {
    "title": "fa fa-podcast",
    "searchTerms": []
}, {
    ...
    "searchTerms": ["times-rectangle"]
}, {
    "title": "fa fa-window-close-o",
    "searchTerms": ["times-rectangle-o"]
}, {
