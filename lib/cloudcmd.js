(function() {
    ...
    var DIR         = __dirname + '/',
        ...
        // OSC_CUSTOM_CODE console-io needs to be disabled serverside to prevent users accessing route
        // Leaving this open would give users bash access to the web host
    ...
    function listen(prefix, socket) {
        ...
        // OSC_CUSTOM_CODE disable console route.
        /*
        webconsole({
